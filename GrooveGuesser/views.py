...
def game(request):
    ...
    songList = [
    ## 90s songs ##
    Song(title="Life is a Highway", artist="Tom Cochrane", year=1991, album="Mad Mad World", path='/static/mp3s/90s/LifeIsAHighwayTomCochrane.mp3', category="90s"),
    Song(title="All Star", artist="Smash Mouth", year=1999, album="Astro Lounge", path='/static/mp3s/90s/All-Star-Smash-Mouth.mp3', category="90s"),
    Song(title="Virtual Insanity", artist="Jamiroquai", year=1996, album="Travelling Without Moving", path='/static/mp3s/90s/Virtual-Insanity-Jamiroquai.mp3', category="90s"),
